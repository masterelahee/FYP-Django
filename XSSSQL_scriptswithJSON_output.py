    ...
    for form in forms:
        ...
        for c in "\"'":
            ...
            for input_tag in form_details["inputs"]:
                if input_tag["type"] == "hidden" or input_tag==["value"] or input_tag==["password"] or input_tag==["username"] or input_tag==["uname"]:
...
if __name__ == "__main__":
    url = "https://sunaccess.sunlifemalaysia.com/portal-ui/CUSTOMER/login#no-back-button"
    url_sql = "https://sunaccess.sunlifemalaysia.com/portal-ui/CUSTOMER/login#no-back-button"
    print(scan_xss(url))
